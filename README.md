...
The goal of this project is to develop a system for the automated classification of lung diseases, specifically focusing on Pneumonia, and COVID-19, using machine learning techniques. 
